...
\]
But each $S_i$ is linearly independent by assumption, so all coefficients $c_v = 0$ for $v \in S_i$. Since this holds for all $i$, all coefficients in our original linear combination are zero.
