...
From the second row: $v_2 = 0$.\\
From the third row: $2v_3 = 0$, so $v_3 = 0$.\\
The first coordinate $v_1$ is free. We set $v_1 = 1$ and get the eigenvector $v = \begin{bmatrix} 1 \\ 0 \\ 0 \end{bmatrix}$.
...
From the second row: $-2v_2 = 0$, so $v_2 = 0$.\\
From the first row: $-2v_1 + v_2 = 0$, so $v_1 = 0$.\\
The third coordinate $v_3$ is free. Taking $v_3 = 1$, we get the eigenvector $v = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix}$.
