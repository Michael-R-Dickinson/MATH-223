...
\begin{solution}
Let $u_1 = \begin{bmatrix} 1\\2\\3\\-4\end{bmatrix}$ and $u_2 = \begin{bmatrix} -5\\4\\3\\2\end{bmatrix}$. We apply the Gram--Schmidt procedure to these spanning vectors to obtain an orthonormal basis of $U$.

\vspace{0.3cm}

First, we normalize $u_1$. We have
\[
...
Next, we orthogonalize $u_2$ against $u_1$ by subtracting off its projection onto $u_1$. We compute the inner product
\[
\langle u_2, u_1 \rangle = (-5)(1) + (4)(2) + (3)(3) + (2)(-4) = -5 + 8 + 9 - 8 = 4.
\]
Thus the component of $u_2$ orthogonal to $u_1$ is
\[
w_2 = u_2 - \frac{\langle u_2, u_1 \rangle}{\norm{u_1}^2} u_1 = u_2 - \frac{4}{30} u_1 = u_2 - \frac{2}{15} u_1.
\]
Computing each entry, we get
\[
w_2 = \begin{bmatrix} -5 - 2/15 \\ 4 - 4/15 \\ 3 - 6/15 \\ 2 + 8/15 \end{bmatrix} = \begin{bmatrix} -77/15 \\ 56/15 \\ 39/15 \\ 38/15 \end{bmatrix} = \frac{1}{15} \begin{bmatrix} -77 \\ 56 \\ 39 \\ 38 \end{bmatrix}.
\]

Now we normalize $w_2$. We have
\[
\norm{w_2}^2 = \frac{1}{225}(77^2 + 56^2 + 39^2 + 38^2) = \frac{1}{225}(5929 + 3136 + 1521 + 1444) = \frac{12030}{225} = \frac{802}{15}
\]
so $\norm{w_2} = \sqrt{802/15} = \frac{\sqrt{12030}}{15}$. Thus
\[
e_2 = \frac{w_2}{\norm{w_2}} = \frac{1}{\sqrt{12030}} \begin{bmatrix} -77 \\ 56 \\ 39 \\ 38 \end{bmatrix}.
\]

Therefore, an orthonormal basis of $U$ is
\[
