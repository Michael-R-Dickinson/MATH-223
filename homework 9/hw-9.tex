...
The subspace $U = \{(x,y) \in \mathbb R^2 \mid y = 4x\}$ is a line through the origin with direction vector $u = \begin{bmatrix} 1 \\ 4 \end{bmatrix}$. Thus
\[
\proj_U(v) = \frac{\langle v, u \rangle}{\norm{u}^2} u = \frac{2 + 24}{1 + 16} \begin{bmatrix} 1 \\ 4 \end{bmatrix} = \frac{26}{17} \begin{bmatrix} 1 \\ 4 \end{bmatrix} = \begin{bmatrix} 26/17 \\ 104/17 \end{bmatrix}.
\]
