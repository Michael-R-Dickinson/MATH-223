...
We apply the Gram-Schmidt process to obtain an orthonormal basis $\mathcal{B}'$ from $\mathcal{B}$.
...
For the remaining vectors, we subtract the projections onto the previous orthonormal vectors and then normalize.

\vspace{0.3cm}

For the second vector, we compute:
\[
