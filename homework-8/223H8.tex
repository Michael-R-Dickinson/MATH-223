...
We apply the Gram-Schmidt process to the basis $(1, x, x^2)$ of $\mathcal{P}_2(\mathbb{R})$ with the inner product $\langle f \mid g \rangle = \int_0^1 f(x)g(x) dx$.
...
For the second polynomial, we compute:
\[
